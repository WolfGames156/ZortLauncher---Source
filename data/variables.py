...
# Website URL
website_url = "https://zortlauncher.con.tc/"
website_url2 = "https://zoream.con.tc/"
...
# Launcher version
version = "1.5.0"
launcher_version = f"release-{version}"
...
if sys.platform == "win32":
    ...
    app_directory = os.path.join(appdata, "ZortLauncher")
elif sys.platform == "linux":
    app_directory = os.path.join(str(pathlib.Path.home()), "ZortLauncher")

# Set plugins directory
if sys.platform == "win32":
    appdata = os.environ["APPDATA"]
    plugins_directory = os.path.join(appdata, "ZortLauncher", "plugins")
    os.makedirs(plugins_directory, exist_ok=True)
elif sys.platform == "linux":
    plugins_directory = os.path.join(str(pathlib.Path.home()), "ZortLauncher", "plugins")
