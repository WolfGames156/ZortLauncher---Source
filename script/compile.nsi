...
!define APPNAME "ZortLauncher"
!define DESCRIPTION "ZortLauncher The Best Free Minecraft Launcher"
!define DEVELOPER "WolfGames"
...
Section "install"
  ...
  CreateShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\ZortLauncher.exe"
  CreateShortCut "$SMPROGRAMS\${APPNAME}\uninstall.lnk" "$INSTDIR\uninstall.exe"
  CreateShortCut "$DESKTOP\${APPNAME}.lnk" "$INSTDIR\ZortLauncher.exe"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APPNAME}" "DisplayIcon" "$INSTDIR\ZortLauncher.exe"
...
Section "uninstall"
  ...
  delete $INSTDIR\ZortLauncher.exe
